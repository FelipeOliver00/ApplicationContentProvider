...
import com.lipe.applicationcontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.lipe.applicationcontentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.lipe.applicationcontentprovider.database.NotesProvider.Companion.URI_NOTES
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if(arguments != null && arguments?.getLong(EXTRA_ID)!= 0L){
           ...
           val uri = Uri.withAppendedPath(URI_NOTES, id.toString())
            //Vamos passar uri que montamos
            //Básicamente o endereço que a gente monto para dentro da pesquisa da activity
           val cursor =
            ...
            //Mata a atividade do cursor para não consumir memória
            cursor.close()
        }
